  ...
  <div class="pt-28 md:pt-40">
    ...
    >
      ...
      >
        ...
        >
          <div
            class="bg-[#05FFF5] md:w-[273px] flex justify-center items-center px-6 md:px-5 lg:px-[30px] h-14 xl:h-[60px] rounded-[5px] md:text-2xl font-bold"
          >
            <img
      ...
      <div class="justify-self-center md:justify-self-end">
        <img
          ...
          class="max-w-[350px] lg:max-w-[410px] xl:max-w-[610px] max-h-[390px] xl:max-h-[590px]"
          alt="bemarketing"
        />
      </div>
    </section>
    ...
    >
      ...
      >
        <img
          src="/services/digital-mkt/business-concept.jpeg"
          class="h-full w-full"
          alt="bemarketing"
        />
      </div>
      ...
      <div class="pl-4">
        ...
        >
          ...
          team of seasoned Local Marketing Experts is strategically positioned
          across the US and globally. Experience distinction with exclusive
          account managers who understand your local market intricacies. Don't
      ...
      >
        ...
        >
          <div class="flex justify-between">
            <h2
              class="text-3xl md:text-4xl xl:text-5xl 2xl:text-[56px] !leading-[72px] font-[500] text-[#05FFF5] self-end"
            >
              Build
            </h2>
            <img
    ...
    >
      ...
      <img
        class="col-span-4 2dx:col-span-8"
        height="576"
    ...
    <section id="portfolio">
      ...
      >
        <div class="relative">
          <div class="text-white flex flex-col space-y-4 mb-20">
            <h4 class="text-2xl font-light">SUCCESS STORIES</h4>
            <h2
              class="text-[#05FFF5] text-2xl md:text-3xl lg:text-4xl xl:text-5xl font-medium"
            >
      ...
      <div class="container-fluid flex space-x-8 mt-26 justify-center">
        ...
        >
          <ClientOnly>
            <fa
              class="text-[#05FFF5] w-full !h-full"
              :icon="['fas', 'arrow-left']"
            />
          </ClientOnly>
        </div>
